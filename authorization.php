...
<script> $('#loginForm').remove(); </script>
	<div id="loginForm" class="col-xs-12 col-sm-8 col-sm-offset-2 col-lg-6 col-md-6 col-lg-offset-3  col-md-offset-3 text-center ">
		<div class="panel panel-primary text-center">
			<div class="panel-heading">
				<h3 class="panel-title">пройдите авторизацию на сайте</h3>
			</div>
