...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Окт 13 2018 г., 00:28
...
(6, 'Евич Илья', 'Евич Илья Андреевич', '0931107156', '', '', 'Чернигов, Босяцкая'),
(12, 'Компьютерная Академия ШАГ', 'Данкевич Светлана Владимировна', '0930005196', '0462919120', 'support@itstep.org', '14000, Чернигов, ул. Пятницкая, 39, 2 этаж'),
(14, 'Голубков Леня', 'Леня', '0997997999', '', '', 'Чернигов, пр. Мира'),
(15, 'Леша Голубков', 'Леша Голубков', '0990000989', '', '', 'Славутич');
...
(2, 'Вася Пупкин', 2, '9499999', NULL),
(4, 'Иванов', 6, '0939990999', ''),
(5, 'Петров Петр Петрович', 0, '0462044044', 'petya@gmail.com'),
(16, 'на выезде', NULL, '8999899989', ''),
(19, 'Барабаш Иван', 0, '0992999399', ''),
(20, 'Леня Голубков', NULL, '0997997999', 'lonya@golub.ua'),
(21, 'Евич Илья', NULL, '0999999999', '');
...
(74, 'работа', 'стоимость моей работы 2', 'шт', '2.00', '2.00', 20),
(75, 'краска синяя', '1банка 1 литр', 'банка 1 литр', '1.00', '25.00', 18),
(76, 'грузок 30г стальной диск', 'на стальные диски', 'шт', '1.00', '3.00', 3);
...
(86, 20, 59, '0.50', '110.00', '1.00', '220.00'),
...
(12, 0, 'AdminPanel', 'templates/viewAdminPanel.php', 'user-tie'),
(13, 12, 'viewAllUsers', 'templates/viewAllUsers.php', 'users'),
(14, 12, 'viewMenu', 'templates/viewMenu.php', 'menu'),
(15, 12, 'NewUser', 'temlates/formAddNewUser.php', 'user-plus');
...
(1, 'вывеска  два в одном с подсветкой для магазина чп Пупкин В С Чернигов', 'нy очень большая можно и поболее размер 0.5м*0.5м на белом фоне красными буквами название магазин пупкина', 1, 1, '99.00', '387.00', 0, 3, 0, '2017-06-28', '2017-08-09', 1, 0),
(2, 'название ЛайтБокс для фирмы   Рога и Копыта Чернигов', 'Это должен быть лайт бокс такой красивусенький-прекрасивусенький', 1, 2, '120.00', '35.00', 0, 0, 0, '2017-06-13', '2017-06-13', 0, 0),
(20, 'скрепка стоппер', 'скрепка стоппер красного цвета с логотипом чп Пупкин and his wife', 0, 1, '10.00', '330.00', 0, 0, 1, '2017-08-16', '2017-08-14', 1, 0),
(21, '3 заказ Пупкину', 'без описания', 0, 1, '0.00', '0.00', 0, 0, 0, '2017-08-12', '2017-08-26', 0, 1),
(22, 'заказ 4 для Пупкина', 'без описания дополнительного', 0, 1, '0.00', '0.00', 0, 0, 0, '2017-08-12', '2017-08-26', 0, 1),
(23, 'вывеска для улицы', '', 0, 2, '0.00', '0.11', 0, 0, 0, '2017-08-22', '2017-09-05', 0, 0),
(24, 'название для проверкм', 'просто описание для проверкм', 6, 2, '0.01', '0.01', 1, 2, 0, '2017-08-31', '2017-09-14', 0, 0),
(25, 'заказ несуществующий для для проверки', 'доп описание для несуществующего заказа', 0, 2, '0.00', '0.00', 0, 1, 0, '2017-08-31', '2017-09-14', 0, 0),
(26, 'еще один заказ для проверки', 'просто без описания', 0, 2, '0.00', '0.00', 0, 0, 0, '2017-08-31', '2017-09-14', 0, 0),
(27, 'скрепка стоппер 2', 'no', 0, 2, '0.00', '0.00', 0, 0, 0, '2017-09-11', '2017-09-25', 0, 0),
(28, 'скрепка стоппер 1', 'no', 0, 2, '0.00', '0.00', 0, 0, 0, '2017-09-11', '2017-09-25', 0, 0),
(29, 'скрепка стоппер 11', 'no', 0, 2, '0.00', '0.00', 0, 0, 0, '2017-09-11', '2017-09-25', 0, 0),
(30, 'рекламный баннер', 'без подробностей', 0, 1, '5000.00', '0.00', 0, 0, 0, '2017-09-12', '2017-09-26', 0, 0),
(31, 'надпись (со слов Вовы)', 'без описания', 0, 4, '0.00', '11690.00', 1, 3, 0, '2017-09-26', '2017-10-10', 0, 0),
(32, 'новый заказ 18:50-04-12-2017', 'без описания нового заказа 18:50-04-12-2017', 0, 4, '0.00', '0.00', 1, 0, 0, '2017-12-04', '2017-12-18', 0, 0),
...
(35, 'ппп', 'ппп', 2, 1, '0.01', '0.02', 0, 0, 0, '2018-06-16', '2018-06-30', 0, 0),
(36, 'Вывеска на центральный вход здания с подсветкой разными буквами цветными', 'вывеска состоит из букв Ш, А, Г. И в каждой будет подсветка. При этом буквы будут переключаться разным цветом раз в 10 секунд. Рядом с большими буквами должна быть надпись поменьше Компьютерная Академия. Все согласно эскизу, согласованному с заказчиком. Документ бумажный и/или электронный', 0, 12, '1.00', '0.00', 0, 0, 0, '2018-08-14', '2018-08-20', 0, 1),
(37, 'машину покрасить', 'левое крыло переднее покрасить под цвет правого крыла', 0, 14, '2000.00', '0.00', 0, 2, 0, '2018-09-19', '2018-10-10', 0, 1),
(38, 'Шиномонтаж 4*R16', 'Сменить резину на зимнюю', 0, 15, '200.00', '0.00', 0, 2, 0, '2018-09-22', '2018-09-22', 0, 1);
...
(2, 2, 2, '2017-07-06', '35.00'),
(13, 1, 1, '2017-07-13', '9.00'),
(27, 2, 2, '2017-07-29', '10.00'),
(45, 26, 2, '2017-09-15', '1.00'),
(47, 21, 1, '2017-09-15', '1.00'),
(48, 1, 1, '2017-09-15', '1.00'),
(51, 1, 1, '2017-09-15', '2.00'),
(52, 23, 2, '2017-09-15', '0.01'),
(53, 23, 2, '2017-09-15', '3.00'),
(54, 23, 2, '2017-09-15', '3.33'),
(56, 23, 2, '2017-09-14', '2.22'),
(58, 20, 1, '2017-09-15', '0.01'),
(59, 20, 1, '2017-09-15', '1.10'),
(60, 23, 2, '2017-09-20', '4.44'),
(61, 21, 1, '2017-09-20', '9.99'),
(62, 23, 2, '2017-09-23', '100.00'),
(63, 31, 4, '2017-09-27', '0.01'),
(64, 31, 4, '2017-09-27', '0.01'),
(65, 31, 4, '2017-09-27', '0.01'),
(66, 31, 4, '2017-09-27', '0.01'),
...
(5, 'поставщик для проверки', 'контакт для проверки', 'поставляет материалы для проверки или нет', '1234567891012', '', 'адрес для проверки', 8, ''),
...
(11, 'разработчик', 'Михаил Рево', 'разработчик этой программы', '0937997990', 'marevo1972@gmail.com', 'Козацкая 16, 48', 6, ''),
...
(18, 'магазин Вена', 'нет', 'краска разная, крепеж', '(0462) 65-30-50', '', 'Чернигов, Героев Чернобыльцев', 6, ''),
...
CREATE TABLE `tasks` (
  ...
  `idUser` int(11) DEFAULT NULL COMMENT 'ответственный из users',
...
CREATE TABLE `users` (
  ...
  `rightUser` varchar(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(1, 'Михаил Рево', 'adminMarevo', '$2y$10$cKjai6Zn7xtJu5HftyUwoOwp1qOcM66eOzgx8h7BP/AjTVL67QJHe', 'marevo1972@gmai.com', NULL, NULL, 'NULL', '1539378960', 'r u d all super c'),
(2, 'Екатерина', 'user', '$2y$10$DgCREMkZ/gHo5XB1VIlY4O8ujrkDTHG19sqFaoPJ8Am.QSQjKrede', 'k.pristupa90@gmail.com', '?', '!', 'NULL', '1539116253', 'c r u d'),
(3, 'Володя Шевченко', 'VovaSheva', '$2y$10$xYaZhPUwG49V2FzOUU.51.YJabJojPXaAjWb6GfXf8zVKHhv5OvgC', 'krastan2@mail.ru', NULL, NULL, NULL, NULL, ' r'),
(4, 'Гость', 'guest', '$2y$10$XOktrkQlxJZQjx9wVqiwcejw9cON4Kx/6lYMz8JZTiEenelSGfa7q', 'marevo1972@gmail.com', NULL, NULL, 'hqa179iqvq926c5r58hjmaqpb3', '1539379559', ' r');
