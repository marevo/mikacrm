                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <form action="../App/controllers/controllerOneClient.php" method="post">
                            <table>
                                ...
                                <tr><td>email</td><td><a target="_blank" title="написать письмо клиенту" href="mailto:<?php echo $client->email0 ; ?>" ><?php echo $client->email0  ?></a></td><td class="tdDisplayNone"><input name="email0" maxlength="30" size="50" type="text" value="<?php echo $client->email0 ?>"/></td></tr>
