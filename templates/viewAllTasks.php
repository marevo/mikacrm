...
<div class="row"><!-- основной блок контета состоит из 12 колонок слева  -->
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12  backForDiv">
        ...
        <div class="row rowSearch"><!-- строка поиска-->
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                <button id="makeNewContactClient" title="создать новый контакт" class="btn btn-primary"><span
                        class='glyphicon glyphicon-plus'></span> новый контакт
                </button>
                <button id="restoreLastDeletedContact" class="btn btn-primary"
                        title="восстановить последний удаленный контакт"><span
                        class='glyphicon glyphicon-cloud-upload'></span> восстановить контакт
                </button>
            </div>
...
</div><!-- row end основного блока контета из 12 колонок слева-->
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    <div class="row" style="background-color: #c0c7d2;">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="row">
                                <div class="col-lg-12 text-center text-danger">хотите удалить этот контакт навсегда ?
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12 text-center " id="modalNameContact"> название контакта</div>
                                <div style="display: none;" class="col-lg-12 text-center " id="modalIdContact"> id
                                    контакта
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 text-center">
                                    <button name="btnDeleteContact" class="btn btn-danger">да</button>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 text-center">
