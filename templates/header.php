...
<!--           <div class=' col-lg-4 col-md-4 col-sm-4 col-xs-4 pod_user'>-->
           <div class='pod_user'>
               <a>
                   <i class="fa-user"></i> <?
                   //TODO: поменял $currentUser на $userAUthorized
...
//                   если есть такой пользователь (по id сессии) в базе 
           ...
           <div class=' col-lg-4 col-md-4 col-sm-4 col-xs-4 pod_exit'>
               <a id="exit"   href="#"   >
                   <i class="icon-exit3"><input type="hidden" name="exitIdUser" value="<?php echo $user->id ?>" /></i>
                   <?php
...
//                       по умолчанию английский
                       $strings = parse_ini_file(__DIR__ . '/../locales/en.ini');
                       echo $strings['exit'];
                   }
                   ?>
               </a>
...
<script type="text/javascript">
    document.getElementById("exit").onclick = function () {
        ...
        formData.append('exitIdUser', $('[name=exitIdUser]').val());
        xhr.send(formData);
		location.reload();
    };
